...
public class GuiCredits extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        //cloudy Client 在Credits添加Cloudy信息的标题
        String cloudyClientAbout = EnumChatFormatting.GRAY + (EnumChatFormatting.BOLD + "About Cloudy Client");
        ...
        //cloudy Client 在Credits添加Cloudy信息
        drawString(this.fontRendererObj, cloudyClientAbout, (this.width - this.fontRendererObj.getStringWidth(cloudyClientAbout)) / 2, fixedHeight + this.fontRendererObj.FONT_HEIGHT * 17, -65536);
        drawString(this.fontRendererObj, "Transplant By zhi_cheng233 | Cloudy Client Team", (this.width - this.fontRendererObj.getStringWidth("Transplant By zhi_cheng233 | Cloudy Client Team")) / 2, fixedHeight + this.fontRendererObj.FONT_HEIGHT * 18, -16712192);
